...
public class FlujoCajaAboutBox extends javax.swing.JDialog {

    public FlujoCajaAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(flujocaja.FlujoCajaApp.class).getContext().getResourceMap(FlujoCajaAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(flujocaja.FlujoCajaApp.class).getContext().getActionMap(FlujoCajaAboutBox.class, this);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(imageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 189, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
